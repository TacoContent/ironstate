...
func (x *ListHandlersResponse) GetHandlerEmojis() map[string]string {
	if x != nil {
		return x.HandlerEmojis
	}
	return nil
}
...
const file_handler_proto_rawDesc = "" +
	"\n" +
	"\rhandler.proto\x12\x13ironstate.plugin.v1\x1a\x1cgoogle/protobuf/struct.proto\"\x81\x01\n" +
	"\aContext\x12+\n" +
